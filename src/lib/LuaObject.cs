...
namespace UniLua
{
	...
	{
		private const UInt64 CLOSURE_LUA = 0xDAED1203; // lua closure
		private const UInt64 CLOSURE_CS = 0xDAEDBAAB; // c# closure
		private const UInt64 CLOSURE_LCS = 0xBAD0FACE; // light c# closure
	...
	public partial class LuaState
	{
		...
		private static double O_Arith( LuaOp op, double v1, double v2 )
		{
			switch( op )
			{
				...
				case LuaOp.LUA_OPMOD: return Utl.LuaMod(v1, v2);
