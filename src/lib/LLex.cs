		...
		private byte _ReadHexEscape()
		{
			...
			for( int i=1; i<3; ++i )
			{
                ...
                if (_CurrentIsDigit())
                    ...
                    r = (r << 4) + Char.ToLower((char)Current) - 'a' + 10;
			}
			return (byte)r;
		}
                ...
                switch( Current )
                {
                    ...
                    case '\\':
                    {
                        ...
                        switch( Current )
                        {
                            ...
                            case 't': c='\t'; break;
                            case 'v': c='\v'; break;
							case 'x': c=(char)_ReadHexEscape(); break;
                            ...
                            case 'u': {
                                ...
                                if (Current != '{')
                                {
                                    _EscapeError( Current.ToString(), "invalid utf string" );
                                }
                                _Next();
                                int r = 0;
                                while (_CurrentIsXDigit())
                                {
                                    if (_CurrentIsDigit())
                                        r = (r << 4) + Current - '0';
                                    else
